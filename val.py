...
def main():
    ...
    for ix in range(0, 14770):
        print("Now doing row number: ", ix)

        x_id = x.iloc[ix]['사번']
        x_num = x.iloc[ix]['논문연번']
        x_rank = x.iloc[ix]['저자순위']
        x_aff = x.iloc[ix]['소속']
        ...
        x.to_csv('scopus_valid.csv', index=False)
    ...
    for ix in range(0, 2746):
        ...
        x2.to_csv('kci_valid.csv', index=False) 
    ...
    for ix in range(0, 2746):
        ...
        x2.to_csv('final_results.csv', index=False)
